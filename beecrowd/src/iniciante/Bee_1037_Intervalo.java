...
public class Bee_1037_Intervalo {
	...
	public static void main(String[] args) {
		...
		if (valor >= 0 && valor <= 25) {
			System.out.println("Bee_1037_Intervalo [0,25]");
		}

		else if (valor > 25 && valor <= 50) {
			System.out.println("Bee_1037_Intervalo (25,50]");
		}

		else if (valor > 50 && valor <= 75) {
			System.out.println("Bee_1037_Intervalo (50,75]");
		}

		else if (valor > 75 && valor <= 100) {
			System.out.println("Bee_1037_Intervalo (75,100]");
		}
